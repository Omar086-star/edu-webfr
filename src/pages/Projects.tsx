...
export default function Projects() {
  ...
  const allTools = useMemo(
    () => [...new Set(publishedProjects.flatMap((p) => p.toolsUsed || []))].sort(),
    [publishedProjects]
  );
  ...
  }, [publishedProjects, search, selectedTool]);
        ...
        <div className="container-wide relative z-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-10 max-w-3xl">
              {[
                { label: "Digital Platforms", value: "12+" },
                { label: "Educational Projects", value: "8+" },
                { label: "Humanitarian Work", value: "5+" },
